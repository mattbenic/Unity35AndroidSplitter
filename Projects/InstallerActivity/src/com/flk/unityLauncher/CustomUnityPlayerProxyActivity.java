...
/**
 * Class extracted from Unity/PlaybackEngines/AndroidPlayer/Sources
 */
public class CustomUnityPlayerProxyActivity extends Activity
{
	protected void onCreate (Bundle savedInstanceState)
	{
		...
		String classNames[] = { "com.flk.unityLauncher.UnityLauncherActivity", "com.flk.unityLauncher.UnityLauncherNativeActivity" };
